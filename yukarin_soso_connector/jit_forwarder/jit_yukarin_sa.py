...
from yukarin_sa.network.predictor import Predictor as YukarinSaPredictor


class JitUniGRU(nn.Module):
...
class JitYukarinSa(nn.Module):
    def __init__(self, predictor: YukarinSaPredictor):
        super().__init__()
        ...
        self.ar_encoder = JitUniGRU(predictor.ar_encoder.rnn)
